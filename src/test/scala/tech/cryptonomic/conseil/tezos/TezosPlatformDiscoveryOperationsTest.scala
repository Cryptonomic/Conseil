...
class TezosPlatformDiscoveryOperationsTest
  ...
  "getEntities" should {
        ...
        sut.getTableAttributes(EntityPath("accounts", networkPath)).futureValue shouldBe
          Some(
            List(
              ...
              Attribute("activated", "Activated", DataType.Boolean, None, KeyType.NonKey, "accounts"),
              Attribute("revealed", "Revealed", DataType.Boolean, None, KeyType.NonKey, "accounts")
            )
          )
      }
      ...
      "return list of attributes of operations" in {
        sut.getTableAttributes(EntityPath("operations", networkPath)).futureValue.value should contain theSameElementsAs List(
