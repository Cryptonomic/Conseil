...
class TezosPlatformDiscoveryOperationsTest
  ...
  "listAttributeValues" should {
      ...
      "correctly apply the filter" in {
        ...
        sut.listAttributeValues("fees", "kind", None).futureValue should contain theSameElementsAs List(
          "example1",
          "example2"
        )
        sut.listAttributeValues("fees", "kind", Some("ex")).futureValue should contain theSameElementsAs List(
          "example1",
          "example2"
        )
        sut.listAttributeValues("fees", "kind", Some("ample")).futureValue should contain theSameElementsAs List(
          "example1",
          "example2"
        )
