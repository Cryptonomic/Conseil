...
trait Tables {
  ...
  case class AccountsRow(accountId: String, blockId: String, manager: Option[String] = None, spendable: Option[Boolean] = None, delegateSetable: Option[Boolean] = None, delegateValue: Option[String] = None, counter: Int, script: Option[String] = None, storage: Option[String] = None, balance: scala.math.BigDecimal, blockLevel: scala.math.BigDecimal = scala.math.BigDecimal("-1"))
  /** GetResult implicit for fetching AccountsRow objects using plain SQL queries */
  implicit def GetResultAccountsRow(implicit e0: GR[String], e1: GR[Option[String]], e2: GR[Option[Boolean]], e3: GR[Int], e4: GR[scala.math.BigDecimal]): GR[AccountsRow] = GR{
    prs => import prs._
