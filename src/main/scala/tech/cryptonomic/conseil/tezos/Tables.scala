...
trait Tables {
  ...
  case class GovernanceRow(
      ...
      yayStake: Option[scala.math.BigDecimal] = None,
      nayStake: Option[scala.math.BigDecimal] = None,
      passStake: Option[scala.math.BigDecimal] = None,
      totalStake: Option[scala.math.BigDecimal] = None,
      periodKind: String,
      periodIndex: Int
  )
  ...
  implicit def GetResultGovernanceRow(
      implicit e0: GR[java.sql.Timestamp],
      e1: GR[Option[Int]],
      e2: GR[String],
  ...
  class Governance(_tableTag: Tag) extends profile.api.Table[GovernanceRow](_tableTag, Some("tezos"), "governance") {
    ...
    def ? =
      (
        (
          ...
          totalStake,
          Rep.Some(periodKind),
          Rep.Some(periodIndex)
        )
      ).shaped.<>(
        { r =>
          import r._;
          _1.map(_ => GovernanceRow.tupled((_1.get, _2, _3, _4.get, _5, _6, _7, _8, _9, _10, _11, _12.get, _13.get)))
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
      )
    ...
    val yayStake: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("yay_stake", O.Default(None))

    /** Database column nay_stake SqlType(numeric), Default(None) */
    val nayStake: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("nay_stake", O.Default(None))

    /** Database column pass_stake SqlType(numeric), Default(None) */
    val passStake: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("pass_stake", O.Default(None))

    /** Database column total_stake SqlType(numeric), Default(None) */
    val totalStake: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("total_stake", O.Default(None))
  ...
  implicit def GetResultVotesRow(
      implicit e0: GR[java.sql.Timestamp],
      e1: GR[Option[Int]],
      e2: GR[String],
      e3: GR[Option[scala.math.BigDecimal]]
  ...
  class Votes(_tableTag: Tag) extends profile.api.Table[VotesRow](_tableTag, Some("tezos"), "votes") {
    def * =
      (timestamp, cycle, level, proposalHash, yayCount, nayCount, passCount, yayStake, nayStake, passStake, totalStake) <> (VotesRow.tupled, VotesRow.unapply)
    ...
    def ? =
      (
        ...
        { r =>
          import r._; _1.map(_ => VotesRow.tupled((_1.get, _2, _3, _4.get, _5, _6, _7, _8, _9, _10, _11)))
        },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
      )
