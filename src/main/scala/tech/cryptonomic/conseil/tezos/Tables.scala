...
trait Tables {
  ...
  case class AccountsRow(accountId: String, blockId: String, counter: Option[Int] = None, script: Option[String] = None, storage: Option[String] = None, balance: scala.math.BigDecimal, blockLevel: scala.math.BigDecimal = scala.math.BigDecimal("-1"), manager: Option[String] = None, spendable: Option[Boolean] = None, delegateSetable: Option[Boolean] = None, delegateValue: Option[String] = None)
  /** GetResult implicit for fetching AccountsRow objects using plain SQL queries */
  implicit def GetResultAccountsRow(implicit e0: GR[String], e1: GR[Option[Int]], e2: GR[Option[String]], e3: GR[scala.math.BigDecimal], e4: GR[Option[Boolean]]): GR[AccountsRow] = GR{
    prs => import prs._
      AccountsRow.tupled((<<[String], <<[String], <<?[Int], <<?[String], <<?[String], <<[scala.math.BigDecimal], <<[scala.math.BigDecimal], <<?[String], <<?[Boolean], <<?[Boolean], <<?[String]))
  }
  ...
  implicit def GetResultAccountsHistoryRow(implicit e0: GR[String], e1: GR[Option[Int]], e2: GR[Option[String]], e3: GR[scala.math.BigDecimal], e4: GR[Option[Boolean]], e5: GR[java.sql.Timestamp]): GR[AccountsHistoryRow] = GR{
    prs => import prs._
      AccountsHistoryRow.tupled((<<[String], <<[String], <<?[Int], <<?[String], <<?[String], <<[scala.math.BigDecimal], <<[scala.math.BigDecimal], <<?[String], <<?[Boolean], <<?[Boolean], <<?[String], <<[java.sql.Timestamp]))
  }
  ...
  class AccountsHistory(_tableTag: Tag) extends profile.api.Table[AccountsHistoryRow](_tableTag, Some("tezos"), "accounts_history") {
    def * = (accountId, blockId, counter, script, storage, balance, blockLevel, manager, spendable, delegateSetable, delegateValue, asof) <> (AccountsHistoryRow.tupled, AccountsHistoryRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(accountId), Rep.Some(blockId), counter, script, storage, Rep.Some(balance), Rep.Some(blockLevel), manager, spendable, delegateSetable, delegateValue, Rep.Some(asof))).shaped.<>({r=>import r._; _1.map(_=> AccountsHistoryRow.tupled((_1.get, _2.get, _3, _4, _5, _6.get, _7.get, _8, _9, _10, _11, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  case class BakingRightsRow(blockHash: String, level: Int, delegate: String, priority: Int, estimatedTime: java.sql.Timestamp, cycle: Option[Int] = None, governancePeriod: Option[Int] = None)
  /** GetResult implicit for fetching BakingRightsRow objects using plain SQL queries */
  implicit def GetResultBakingRightsRow(implicit e0: GR[String], e1: GR[Int], e2: GR[java.sql.Timestamp], e3: GR[Option[Int]]): GR[BakingRightsRow] = GR{
    prs => import prs._
  ...
  class BakingRights(_tableTag: Tag) extends profile.api.Table[BakingRightsRow](_tableTag, Some("tezos"), "baking_rights") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(blockHash), Rep.Some(level), Rep.Some(delegate), Rep.Some(priority), Rep.Some(estimatedTime), cycle, governancePeriod)).shaped.<>({r=>import r._; _1.map(_=> BakingRightsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table EndorsingRights
    ...
    *  @param cycle Database column cycle SqlType(int4), Default(None)
    *  @param governancePeriod Database column governance_period SqlType(int4), Default(None) */
  case class EndorsingRightsRow(blockHash: String, level: Int, delegate: String, slot: Int, estimatedTime: java.sql.Timestamp, cycle: Option[Int] = None, governancePeriod: Option[Int] = None)
  /** GetResult implicit for fetching EndorsingRightsRow objects using plain SQL queries */
  implicit def GetResultEndorsingRightsRow(implicit e0: GR[String], e1: GR[Int], e2: GR[java.sql.Timestamp], e3: GR[Option[Int]]): GR[EndorsingRightsRow] = GR{
    prs => import prs._
  ...
  class EndorsingRights(_tableTag: Tag) extends profile.api.Table[EndorsingRightsRow](_tableTag, Some("tezos"), "endorsing_rights") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(blockHash), Rep.Some(level), Rep.Some(delegate), Rep.Some(slot), Rep.Some(estimatedTime), cycle, governancePeriod)).shaped.<>({r=>import r._; _1.map(_=> EndorsingRightsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
