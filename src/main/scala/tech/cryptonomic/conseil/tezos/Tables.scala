...
trait Tables {
  ...
  case class BigMapContentsRow(
      bigMapId: Option[scala.math.BigDecimal] = None,
  ...
  implicit def GetResultBigMapContentsRow(
      implicit e0: GR[Option[scala.math.BigDecimal]],
      e1: GR[Option[String]]
  ...
  class BigMapContents(_tableTag: Tag)
    ...
    val bigMapId: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("big_map_id", O.Default(None))
