...
trait Tables {
  ...
  class Accounts(_tableTag: Tag) extends profile.api.Table[AccountsRow](_tableTag, "accounts") {
    def * =
      (accountId, blockId, manager, spendable, delegateSetable, delegateValue, counter, script, balance, blockLevel) <> (AccountsRow.tupled, AccountsRow.unapply)
    ...
    def ? =
      (
        ...
        { r =>
          import r._;
          _1.map(_ => AccountsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7.get, _8, _9.get, _10.get)))
        },
  ...
  implicit def GetResultBakersRow(implicit e0: GR[String], e1: GR[Int]): GR[BakersRow] = GR { prs =>
    import prs._
  ...
  class Bakers(_tableTag: Tag) extends profile.api.Table[BakersRow](_tableTag, "bakers") {
    ...
    def ? =
      ((Rep.Some(pkh), Rep.Some(rolls), Rep.Some(blockId), Rep.Some(blockLevel))).shaped.<>({ r =>
        import r._; _1.map(_ => BakersRow.tupled((_1.get, _2.get, _3.get, _4.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    lazy val blocksFk = foreignKey("baker_block_id_fkey", blockId, Blocks)(
      r => r.hash,
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.NoAction
    )
  ...
  class Operations(_tableTag: Tag) extends profile.api.Table[OperationsRow](_tableTag, "operations") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(operationId) :: Rep.Some(operationGroupHash) :: Rep.Some(kind) :: level :: delegate :: slots :: nonce :: pkh :: secret :: source :: fee :: counter :: gasLimit :: storageLimit :: publicKey :: amount :: destination :: parameters :: managerPubkey :: balance :: spendable :: delegatable :: script :: status :: consumedGas :: Rep
        ...
        r =>
          OperationsRow(
            ...
            r(25).asInstanceOf[Option[String]].get,
