...
object TezosPlatformDiscoveryOperations {
  def apply(apiOperations: ApiOperations): TezosPlatformDiscoveryOperations = new TezosPlatformDiscoveryOperations(apiOperations)
...
class TezosPlatformDiscoveryOperations(apiOperations: ApiOperations) {
  import TezosPlatformDiscoveryOperations._
