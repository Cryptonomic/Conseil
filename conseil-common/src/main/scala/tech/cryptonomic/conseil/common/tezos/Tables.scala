...
trait Tables {
  ...
  case class AccountsRow(
      ...
      delegateSetable: Option[Boolean],
      delegateValue: Option[String],
  ...
  case class BlocksRow(
      ...
      periodKind: Option[String],
      currentExpectedQuorum: Option[Int],
      activeProposal: Option[String],
      baker: Option[String],
      consumedGas: Option[scala.math.BigDecimal],
      metaLevel: Option[Long],
      metaLevelPosition: Option[Int],
      metaCycle: Option[Int],
      metaCyclePosition: Option[Int],
      metaVotingPeriod: Option[Int],
      metaVotingPeriodPosition: Option[Int],
      priority: Option[Int],
      utcYear: Int,
      utcMonth: Int,
      utcDay: Int,
  ...
  case class GovernanceRow(
      ...
      yayCount: Option[Int],
      nayCount: Option[Int],
      passCount: Option[Int],
      yayRolls: Option[scala.math.BigDecimal],
      nayRolls: Option[scala.math.BigDecimal],
      passRolls: Option[scala.math.BigDecimal],
      totalRolls: Option[scala.math.BigDecimal],
      blockYayCount: Option[Int],
      blockNayCount: Option[Int],
      blockPassCount: Option[Int],
      blockYayRolls: Option[scala.math.BigDecimal],
      blockNayRolls: Option[scala.math.BigDecimal],
      blockPassRolls: Option[scala.math.BigDecimal],
      invalidatedAsof: Option[java.sql.Timestamp],
      forkId: String
  )
  ...
  case class MetadataRow(
      ...
      lastUpdated: Option[java.sql.Timestamp]
  )
  ...
  case class OperationsRow(
      ...
      slots: Option[String],
      nonce: Option[String],
      operationOrder: Option[Int],
      pkh: Option[String],
      secret: Option[String],
      source: Option[String],
      fee: Option[scala.math.BigDecimal],
      counter: Option[scala.math.BigDecimal],
      gasLimit: Option[scala.math.BigDecimal],
      storageLimit: Option[scala.math.BigDecimal],
      publicKey: Option[String],
      amount: Option[scala.math.BigDecimal],
      destination: Option[String],
      parameters: Option[String],
      parametersEntrypoints: Option[String],
      parametersMicheline: Option[String],
      ...
      script: Option[String],
      storage: Option[String],
      storageMicheline: Option[String],
      status: Option[String],
      consumedGas: Option[scala.math.BigDecimal],
      storageSize: Option[scala.math.BigDecimal],
      paidStorageSizeDiff: Option[scala.math.BigDecimal],
