...
trait Tables {
   ...
   *  @param cycle Database column cycle SqlType(int4), Default(None)
   *  @param period Database column period SqlType(int4), Default(None) */
  case class BigMapContentsRow(bigMapId: scala.math.BigDecimal, key: String, keyHash: Option[String] = None, operationGroupId: Option[String] = None, value: Option[String] = None, blockLevel: Option[Long] = None, timestamp: Option[java.sql.Timestamp] = None, cycle: Option[Int] = None, period: Option[Int] = None)
  ...
  implicit def GetResultBigMapContentsRow(implicit e0: GR[scala.math.BigDecimal], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[Long]], e4: GR[Option[java.sql.Timestamp]], e5: GR[Option[Int]]): GR[BigMapContentsRow] = GR{
    prs => import prs._
      BigMapContentsRow.tupled((<<[scala.math.BigDecimal], <<[String], <<?[String], <<?[String], <<?[String], <<?[Long], <<?[java.sql.Timestamp], <<?[Int], <<?[Int]))
  }
  ...
  class BigMapContents(_tableTag: Tag) extends profile.api.Table[BigMapContentsRow](_tableTag, Some("tezos"), "big_map_contents") {
    def * = (bigMapId, key, keyHash, operationGroupId, value, blockLevel, timestamp, cycle, period) <> (BigMapContentsRow.tupled, BigMapContentsRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(bigMapId), Rep.Some(key), keyHash, operationGroupId, value, blockLevel, timestamp, cycle, period)).shaped.<>({r=>import r._; _1.map(_=> BigMapContentsRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7, _8, _9)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class KnownAddresses(_tableTag: Tag) extends profile.api.Table[KnownAddressesRow](_tableTag, Some("tezos"), "known_addresses") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(address), alias)).shaped.<>({r=>import r._; _1.map(_=> KnownAddressesRow.tupled((_1.get, _2)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  case class MetadataRow(address: String, rawMetadata: String, name: String, desctiption: Option[String] = None, lastUpdated: Option[java.sql.Timestamp] = None)
  ...
  class Metadata(_tableTag: Tag) extends profile.api.Table[MetadataRow](_tableTag, Some("tezos"), "metadata") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(address), Rep.Some(rawMetadata), Rep.Some(name), desctiption, lastUpdated)).shaped.<>({r=>import r._; _1.map(_=> MetadataRow.tupled((_1.get, _2.get, _3.get, _4, _5)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
   ...
   *  @param rawMetadata Database column raw_metadata SqlType(text)
   *  @param lastUpdated Database column last_updated SqlType(timestamp), Default(None) */
  case class NftsRow(contractAddress: String, contractName: String, assetType: String, assetLocation: String, rawMetadata: String, lastUpdated: Option[java.sql.Timestamp] = None)
  /** GetResult implicit for fetching NftsRow objects using plain SQL queries */
  implicit def GetResultNftsRow(implicit e0: GR[String], e1: GR[Option[java.sql.Timestamp]]): GR[NftsRow] = GR{
    prs => import prs._
      NftsRow.tupled((<<[String], <<[String], <<[String], <<[String], <<[String], <<?[java.sql.Timestamp]))
  }
  ...
  class Nfts(_tableTag: Tag) extends profile.api.Table[NftsRow](_tableTag, Some("tezos"), "nfts") {
    def * = (contractAddress, contractName, assetType, assetLocation, rawMetadata, lastUpdated) <> (NftsRow.tupled, NftsRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(contractAddress), Rep.Some(contractName), Rep.Some(assetType), Rep.Some(assetLocation), Rep.Some(rawMetadata), lastUpdated)).shaped.<>({r=>import r._; _1.map(_=> NftsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
   ...
   *  @param invalidatedAsof Database column invalidated_asof SqlType(timestamp), Default(None)
   *  @param forkId Database column fork_id SqlType(varchar) */
  case class OperationsRow(branch: Option[String] = None, numberOfSlots: Option[Int] = None, cycle: Option[Int] = None, operationId: Int, operationGroupHash: String, kind: String, level: Option[Long] = None, delegate: Option[String] = None, slots: Option[String] = None, nonce: Option[String] = None, pkh: Option[String] = None, secret: Option[String] = None, source: Option[String] = None, fee: Option[scala.math.BigDecimal] = None, counter: Option[scala.math.BigDecimal] = None, gasLimit: Option[scala.math.BigDecimal] = None, storageLimit: Option[scala.math.BigDecimal] = None, publicKey: Option[String] = None, amount: Option[scala.math.BigDecimal] = None, destination: Option[String] = None, parameters: Option[String] = None, parametersEntrypoints: Option[String] = None, parametersMicheline: Option[String] = None, managerPubkey: Option[String] = None, balance: Option[scala.math.BigDecimal] = None, proposal: Option[String] = None, spendable: Option[Boolean] = None, delegatable: Option[Boolean] = None, script: Option[String] = None, storage: Option[String] = None, status: Option[String] = None, consumedGas: Option[scala.math.BigDecimal] = None, storageSize: Option[scala.math.BigDecimal] = None, paidStorageSizeDiff: Option[scala.math.BigDecimal] = None, originatedContracts: Option[String] = None, blockHash: String, blockLevel: Long, ballot: Option[String] = None, internal: Boolean, period: Option[Int] = None, ballotPeriod: Option[Int] = None, timestamp: java.sql.Timestamp, errors: Option[String] = None, utcYear: Int, utcMonth: Int, utcDay: Int, utcTime: String, invalidatedAsof: Option[java.sql.Timestamp] = None, forkId: String)
  ...
  implicit def GetResultOperationsRow(implicit e0: GR[Option[String]], e1: GR[Option[Int]], e2: GR[Int], e3: GR[String], e4: GR[Option[Long]], e5: GR[Option[scala.math.BigDecimal]], e6: GR[Option[Boolean]], e7: GR[Long], e8: GR[Boolean], e9: GR[java.sql.Timestamp], e10: GR[Option[java.sql.Timestamp]]): GR[OperationsRow] = GR{
    prs => import prs._
      OperationsRow(<<?[String], <<?[Int], <<?[Int], <<[Int], <<[String], <<[String], <<?[Long], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[String], <<?[scala.math.BigDecimal], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[String], <<?[Boolean], <<?[Boolean], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[String], <<[String], <<[Long], <<?[String], <<[Boolean], <<?[Int], <<?[Int], <<[java.sql.Timestamp], <<?[String], <<[Int], <<[Int], <<[Int], <<[String], <<?[java.sql.Timestamp], <<[String])
  }
  ...
  case class RegisteredTokensRow(id: Int, name: String, contractType: String, accountId: String, scale: Int, interfaces: String, isTzip16: Boolean, isNft: Boolean, metadataType: String, metadataBigMapId: Int, metadataBigMapType: String, metadataPath: String)
  /** GetResult implicit for fetching RegisteredTokensRow objects using plain SQL queries */
  implicit def GetResultRegisteredTokensRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Boolean]): GR[RegisteredTokensRow] = GR{
    prs => import prs._
      RegisteredTokensRow.tupled((<<[Int], <<[String], <<[String], <<[String], <<[Int], <<[String], <<[Boolean], <<[Boolean], <<[String], <<[Int], <<[String], <<[String]))
  }
  ...
  class RegisteredTokens(_tableTag: Tag) extends profile.api.Table[RegisteredTokensRow](_tableTag, Some("tezos"), "registered_tokens") {
    def * = (id, name, contractType, accountId, scale, interfaces, isTzip16, isNft, metadataType, metadataBigMapId, metadataBigMapType, metadataPath) <> (RegisteredTokensRow.tupled, RegisteredTokensRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(id), Rep.Some(name), Rep.Some(contractType), Rep.Some(accountId), Rep.Some(scale), Rep.Some(interfaces), Rep.Some(isTzip16), Rep.Some(isNft), Rep.Some(metadataType), Rep.Some(metadataBigMapId), Rep.Some(metadataBigMapType), Rep.Some(metadataPath))).shaped.<>({r=>import r._; _1.map(_=> RegisteredTokensRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
   ...
   *  @param invalidatedAsof Database column invalidated_asof SqlType(timestamp), Default(None)
   *  @param forkId Database column fork_id SqlType(varchar) */
  case class TokenBalancesRow(tokenId: Int, address: String, balance: scala.math.BigDecimal, blockId: String, blockLevel: Long = -1L, asof: java.sql.Timestamp, invalidatedAsof: Option[java.sql.Timestamp] = None, forkId: String)
  /** GetResult implicit for fetching TokenBalancesRow objects using plain SQL queries */
  implicit def GetResultTokenBalancesRow(implicit e0: GR[Int], e1: GR[String], e2: GR[scala.math.BigDecimal], e3: GR[Long], e4: GR[java.sql.Timestamp], e5: GR[Option[java.sql.Timestamp]]): GR[TokenBalancesRow] = GR{
    prs => import prs._
      TokenBalancesRow.tupled((<<[Int], <<[String], <<[scala.math.BigDecimal], <<[String], <<[Long], <<[java.sql.Timestamp], <<?[java.sql.Timestamp], <<[String]))
  }
  ...
  class TokenBalances(_tableTag: Tag) extends profile.api.Table[TokenBalancesRow](_tableTag, Some("tezos"), "token_balances") {
    def * = (tokenId, address, balance, blockId, blockLevel, asof, invalidatedAsof, forkId) <> (TokenBalancesRow.tupled, TokenBalancesRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(tokenId), Rep.Some(address), Rep.Some(balance), Rep.Some(blockId), Rep.Some(blockLevel), Rep.Some(asof), invalidatedAsof, Rep.Some(forkId))).shaped.<>({r=>import r._; _1.map(_=> TokenBalancesRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7, _8.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
