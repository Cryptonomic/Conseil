...
trait Tables {
   ...
   *  @param invalidatedAsof Database column invalidated_asof SqlType(timestamp), Default(None)
   *  @param forkId Database column fork_id SqlType(varchar) */
  case class BakersRow(pkh: String, blockId: String, balance: Option[scala.math.BigDecimal] = None, frozenBalance: Option[scala.math.BigDecimal] = None, stakingBalance: Option[scala.math.BigDecimal] = None, delegatedBalance: Option[scala.math.BigDecimal] = None, rolls: Long = 0L, deactivated: Boolean, gracePeriod: Int, blockLevel: Long = -1L, cycle: Option[Int] = None, period: Option[Int] = None, invalidatedAsof: Option[java.sql.Timestamp] = None, forkId: String)
  /** GetResult implicit for fetching BakersRow objects using plain SQL queries */
  implicit def GetResultBakersRow(implicit e0: GR[String], e1: GR[Option[scala.math.BigDecimal]], e2: GR[Long], e3: GR[Boolean], e4: GR[Int], e5: GR[Option[Int]], e6: GR[Option[java.sql.Timestamp]]): GR[BakersRow] = GR{
    prs => import prs._
      BakersRow.tupled((<<[String], <<[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<[Long], <<[Boolean], <<[Int], <<[Long], <<?[Int], <<?[Int], <<?[java.sql.Timestamp], <<[String]))
  }
   ...
   *  @param invalidatedAsof Database column invalidated_asof SqlType(timestamp), Default(None)
   *  @param forkId Database column fork_id SqlType(varchar) */
  case class BakersHistoryRow(pkh: String, blockId: String, balance: Option[scala.math.BigDecimal] = None, frozenBalance: Option[scala.math.BigDecimal] = None, stakingBalance: Option[scala.math.BigDecimal] = None, delegatedBalance: Option[scala.math.BigDecimal] = None, rolls: Long = 0L, deactivated: Boolean, gracePeriod: Int, blockLevel: Long = -1L, cycle: Option[Int] = None, period: Option[Int] = None, asof: java.sql.Timestamp, invalidatedAsof: Option[java.sql.Timestamp] = None, forkId: String)
  /** GetResult implicit for fetching BakersHistoryRow objects using plain SQL queries */
  implicit def GetResultBakersHistoryRow(implicit e0: GR[String], e1: GR[Option[scala.math.BigDecimal]], e2: GR[Long], e3: GR[Boolean], e4: GR[Int], e5: GR[Option[Int]], e6: GR[java.sql.Timestamp], e7: GR[Option[java.sql.Timestamp]]): GR[BakersHistoryRow] = GR{
    prs => import prs._
      BakersHistoryRow.tupled((<<[String], <<[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<[Long], <<[Boolean], <<[Int], <<[Long], <<?[Int], <<?[Int], <<[java.sql.Timestamp], <<?[java.sql.Timestamp], <<[String]))
  }
   ...
   *  @param consumedMilligas Database column consumed_milligas SqlType(numeric), Default(None)
   ...
   *  @param invalidatedAsof Database column invalidated_asof SqlType(timestamp), Default(None)
   *  @param forkId Database column fork_id SqlType(varchar) */
  case class BlocksRow(level: Long, proto: Int, predecessor: String, timestamp: java.sql.Timestamp, fitness: String, context: Option[String] = None, signature: Option[String] = None, protocol: String, chainId: Option[String] = None, hash: String, operationsHash: Option[String] = None, periodKind: Option[String] = None, currentExpectedQuorum: Option[Int] = None, activeProposal: Option[String] = None, baker: Option[String] = None, consumedGas: Option[scala.math.BigDecimal] = None, consumedMilligas: Option[scala.math.BigDecimal] = None, metaLevel: Option[Long] = None, metaLevelPosition: Option[Int] = None, metaCycle: Option[Int] = None, metaCyclePosition: Option[Int] = None, metaVotingPeriod: Option[Int] = None, metaVotingPeriodPosition: Option[Int] = None, priority: Option[Int] = None, utcYear: Int, utcMonth: Int, utcDay: Int, utcTime: String, invalidatedAsof: Option[java.sql.Timestamp] = None, forkId: String)
  ...
  implicit def GetResultBlocksRow(implicit e0: GR[Long], e1: GR[Int], e2: GR[String], e3: GR[java.sql.Timestamp], e4: GR[Option[String]], e5: GR[Option[Int]], e6: GR[Option[scala.math.BigDecimal]], e7: GR[Option[Long]], e8: GR[Option[java.sql.Timestamp]]): GR[BlocksRow] = GR{
    prs => import prs._
      BlocksRow(<<[Long], <<[Int], <<[String], <<[java.sql.Timestamp], <<[String], <<?[String], <<?[String], <<[String], <<?[String], <<[String], <<?[String], <<?[String], <<?[Int], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[Long], <<?[Int], <<?[Int], <<?[Int], <<?[Int], <<?[Int], <<?[Int], <<[Int], <<[Int], <<[Int], <<[String], <<?[java.sql.Timestamp], <<[String])
  }
  ...
  class Blocks(_tableTag: Tag) extends profile.api.Table[BlocksRow](_tableTag, Some("tezos"), "blocks") {
    def * = (level :: proto :: predecessor :: timestamp :: fitness :: context :: signature :: protocol :: chainId :: hash :: operationsHash :: periodKind :: currentExpectedQuorum :: activeProposal :: baker :: consumedGas :: consumedMilligas :: metaLevel :: metaLevelPosition :: metaCycle :: metaCyclePosition :: metaVotingPeriod :: metaVotingPeriodPosition :: priority :: utcYear :: utcMonth :: utcDay :: utcTime :: invalidatedAsof :: forkId :: HNil).mapTo[BlocksRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(level) :: Rep.Some(proto) :: Rep.Some(predecessor) :: Rep.Some(timestamp) :: Rep.Some(fitness) :: context :: signature :: Rep.Some(protocol) :: chainId :: Rep.Some(hash) :: operationsHash :: periodKind :: currentExpectedQuorum :: activeProposal :: baker :: consumedGas :: consumedMilligas :: metaLevel :: metaLevelPosition :: metaCycle :: metaCyclePosition :: metaVotingPeriod :: metaVotingPeriodPosition :: priority :: Rep.Some(utcYear) :: Rep.Some(utcMonth) :: Rep.Some(utcDay) :: Rep.Some(utcTime) :: invalidatedAsof :: Rep.Some(forkId) :: HNil).shaped.<>(r => BlocksRow(r(0).asInstanceOf[Option[Long]].get, r(1).asInstanceOf[Option[Int]].get, r(2).asInstanceOf[Option[String]].get, r(3).asInstanceOf[Option[java.sql.Timestamp]].get, r(4).asInstanceOf[Option[String]].get, r(5).asInstanceOf[Option[String]], r(6).asInstanceOf[Option[String]], r(7).asInstanceOf[Option[String]].get, r(8).asInstanceOf[Option[String]], r(9).asInstanceOf[Option[String]].get, r(10).asInstanceOf[Option[String]], r(11).asInstanceOf[Option[String]], r(12).asInstanceOf[Option[Int]], r(13).asInstanceOf[Option[String]], r(14).asInstanceOf[Option[String]], r(15).asInstanceOf[Option[scala.math.BigDecimal]], r(16).asInstanceOf[Option[scala.math.BigDecimal]], r(17).asInstanceOf[Option[Long]], r(18).asInstanceOf[Option[Int]], r(19).asInstanceOf[Option[Int]], r(20).asInstanceOf[Option[Int]], r(21).asInstanceOf[Option[Int]], r(22).asInstanceOf[Option[Int]], r(23).asInstanceOf[Option[Int]], r(24).asInstanceOf[Option[Int]].get, r(25).asInstanceOf[Option[Int]].get, r(26).asInstanceOf[Option[Int]].get, r(27).asInstanceOf[Option[String]].get, r(28).asInstanceOf[Option[java.sql.Timestamp]], r(29).asInstanceOf[Option[String]].get), (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column consumed_milligas SqlType(numeric), Default(None) */
    val consumedMilligas: Rep[Option[scala.math.BigDecimal]] = column[Option[scala.math.BigDecimal]]("consumed_milligas", O.Default(None))
   ...
   *  @param invalidatedAsof Database column invalidated_asof SqlType(timestamp), Default(None)
   *  @param forkId Database column fork_id SqlType(varchar) */
  case class GovernanceRow(votingPeriod: Int, votingPeriodKind: String, cycle: Option[Int] = None, level: Option[Long] = None, blockHash: String, proposalHash: String, yayCount: Option[Long] = None, nayCount: Option[Long] = None, passCount: Option[Long] = None, yayRolls: Option[Long] = None, nayRolls: Option[Long] = None, passRolls: Option[Long] = None, totalRolls: Option[Long] = None, blockYayCount: Option[Long] = None, blockNayCount: Option[Long] = None, blockPassCount: Option[Long] = None, blockYayRolls: Option[Long] = None, blockNayRolls: Option[Long] = None, blockPassRolls: Option[Long] = None, invalidatedAsof: Option[java.sql.Timestamp] = None, forkId: String)
  /** GetResult implicit for fetching GovernanceRow objects using plain SQL queries */
  implicit def GetResultGovernanceRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Option[Int]], e3: GR[Option[Long]], e4: GR[Option[java.sql.Timestamp]]): GR[GovernanceRow] = GR{
    prs => import prs._
      GovernanceRow.tupled((<<[Int], <<[String], <<?[Int], <<?[Long], <<[String], <<[String], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[java.sql.Timestamp], <<[String]))
  }
   ...
   *  @param eventtype Database column eventtype SqlType(varchar), Default(None)
   *  @param tag Database column tag SqlType(varchar), Default(None)
   *  @param payload Database column payload SqlType(varchar), Default(None)
   *  @param solution Database column solution SqlType(varchar), Default(None)
   *  @param timestamp Database column timestamp SqlType(timestamp)
  ...
  implicit def GetResultOperationsRow(implicit e0: GR[Option[String]], e1: GR[Option[Int]], e2: GR[Int], e3: GR[String], e4: GR[Option[Long]], e5: GR[Option[scala.math.BigDecimal]], e6: GR[Option[Boolean]], e7: GR[Long], e8: GR[Boolean], e9: GR[java.sql.Timestamp], e10: GR[Option[java.sql.Timestamp]]): GR[OperationsRow] = GR{
    prs => import prs._
      OperationsRow(<<?[String], <<?[Int], <<?[Int], <<[Int], <<[String], <<[String], <<?[Long], <<?[String], <<?[String], <<?[String], <<?[Int], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[String], <<?[scala.math.BigDecimal], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[String], <<?[Boolean], <<?[Boolean], <<?[String], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[String], <<[String], <<[Long], <<?[String], <<[Boolean], <<?[Int], <<?[Int], <<?[String], <<?[String], <<?[String], <<?[String], <<[java.sql.Timestamp], <<?[String], <<[Int], <<[Int], <<[Int], <<[String], <<?[java.sql.Timestamp], <<[String])
  }
  ...
  class Operations(_tableTag: Tag) extends profile.api.Table[OperationsRow](_tableTag, Some("tezos"), "operations") {
    def * = (branch :: numberOfSlots :: cycle :: operationId :: operationGroupHash :: kind :: level :: delegate :: slots :: nonce :: operationOrder :: pkh :: secret :: source :: fee :: counter :: gasLimit :: storageLimit :: publicKey :: amount :: destination :: parameters :: parametersEntrypoints :: parametersMicheline :: managerPubkey :: balance :: proposal :: spendable :: delegatable :: script :: storage :: storageMicheline :: status :: consumedGas :: consumedMilligas :: storageSize :: paidStorageSizeDiff :: originatedContracts :: blockHash :: blockLevel :: ballot :: internal :: period :: ballotPeriod :: eventtype :: tag :: payload :: solution :: timestamp :: errors :: utcYear :: utcMonth :: utcDay :: utcTime :: invalidatedAsof :: forkId :: HNil).mapTo[OperationsRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (branch :: numberOfSlots :: cycle :: Rep.Some(operationId) :: Rep.Some(operationGroupHash) :: Rep.Some(kind) :: level :: delegate :: slots :: nonce :: operationOrder :: pkh :: secret :: source :: fee :: counter :: gasLimit :: storageLimit :: publicKey :: amount :: destination :: parameters :: parametersEntrypoints :: parametersMicheline :: managerPubkey :: balance :: proposal :: spendable :: delegatable :: script :: storage :: storageMicheline :: status :: consumedGas :: consumedMilligas :: storageSize :: paidStorageSizeDiff :: originatedContracts :: Rep.Some(blockHash) :: Rep.Some(blockLevel) :: ballot :: Rep.Some(internal) :: period :: ballotPeriod :: eventtype :: tag :: payload :: solution :: Rep.Some(timestamp) :: errors :: Rep.Some(utcYear) :: Rep.Some(utcMonth) :: Rep.Some(utcDay) :: Rep.Some(utcTime) :: invalidatedAsof :: Rep.Some(forkId) :: HNil).shaped.<>(r => OperationsRow(r(0).asInstanceOf[Option[String]], r(1).asInstanceOf[Option[Int]], r(2).asInstanceOf[Option[Int]], r(3).asInstanceOf[Option[Int]].get, r(4).asInstanceOf[Option[String]].get, r(5).asInstanceOf[Option[String]].get, r(6).asInstanceOf[Option[Long]], r(7).asInstanceOf[Option[String]], r(8).asInstanceOf[Option[String]], r(9).asInstanceOf[Option[String]], r(10).asInstanceOf[Option[Int]], r(11).asInstanceOf[Option[String]], r(12).asInstanceOf[Option[String]], r(13).asInstanceOf[Option[String]], r(14).asInstanceOf[Option[scala.math.BigDecimal]], r(15).asInstanceOf[Option[scala.math.BigDecimal]], r(16).asInstanceOf[Option[scala.math.BigDecimal]], r(17).asInstanceOf[Option[scala.math.BigDecimal]], r(18).asInstanceOf[Option[String]], r(19).asInstanceOf[Option[scala.math.BigDecimal]], r(20).asInstanceOf[Option[String]], r(21).asInstanceOf[Option[String]], r(22).asInstanceOf[Option[String]], r(23).asInstanceOf[Option[String]], r(24).asInstanceOf[Option[String]], r(25).asInstanceOf[Option[scala.math.BigDecimal]], r(26).asInstanceOf[Option[String]], r(27).asInstanceOf[Option[Boolean]], r(28).asInstanceOf[Option[Boolean]], r(29).asInstanceOf[Option[String]], r(30).asInstanceOf[Option[String]], r(31).asInstanceOf[Option[String]], r(32).asInstanceOf[Option[String]], r(33).asInstanceOf[Option[scala.math.BigDecimal]], r(34).asInstanceOf[Option[scala.math.BigDecimal]], r(35).asInstanceOf[Option[scala.math.BigDecimal]], r(36).asInstanceOf[Option[scala.math.BigDecimal]], r(37).asInstanceOf[Option[String]], r(38).asInstanceOf[Option[String]].get, r(39).asInstanceOf[Option[Long]].get, r(40).asInstanceOf[Option[String]], r(41).asInstanceOf[Option[Boolean]].get, r(42).asInstanceOf[Option[Int]], r(43).asInstanceOf[Option[Int]], r(44).asInstanceOf[Option[String]], r(45).asInstanceOf[Option[String]], r(46).asInstanceOf[Option[String]], r(47).asInstanceOf[Option[String]], r(48).asInstanceOf[Option[java.sql.Timestamp]].get, r(49).asInstanceOf[Option[String]], r(50).asInstanceOf[Option[Int]].get, r(51).asInstanceOf[Option[Int]].get, r(52).asInstanceOf[Option[Int]].get, r(53).asInstanceOf[Option[String]].get, r(54).asInstanceOf[Option[java.sql.Timestamp]], r(55).asInstanceOf[Option[String]].get), (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column eventtype SqlType(varchar), Default(None) */
    val eventtype: Rep[Option[String]] = column[Option[String]]("eventtype", O.Default(None))
    /** Database column tag SqlType(varchar), Default(None) */
    val tag: Rep[Option[String]] = column[Option[String]]("tag", O.Default(None))
    /** Database column payload SqlType(varchar), Default(None) */
    val payload: Rep[Option[String]] = column[Option[String]]("payload", O.Default(None))
    /** Database column solution SqlType(varchar), Default(None) */
    val solution: Rep[Option[String]] = column[Option[String]]("solution", O.Default(None))
    /** Database column timestamp SqlType(timestamp) */
    val timestamp: Rep[java.sql.Timestamp] = column[java.sql.Timestamp]("timestamp")
