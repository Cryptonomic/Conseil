...
trait Tables {
  ...
  class Blocks(_tableTag: Tag) extends profile.api.Table[BlocksRow](_tableTag, Some("bitcoin"), "blocks") {
    def * = (hash, size, strippedSize, weight, height, version, versionHex, merkleRoot, nonce, bits, difficulty, chainWork, nTx, previousBlockHash, nextBlockHash, medianTime, time) <> (BlocksRow.tupled, BlocksRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(hash), Rep.Some(size), Rep.Some(strippedSize), Rep.Some(weight), Rep.Some(height), Rep.Some(version), Rep.Some(versionHex), Rep.Some(merkleRoot), Rep.Some(nonce), Rep.Some(bits), Rep.Some(difficulty), Rep.Some(chainWork), Rep.Some(nTx), previousBlockHash, nextBlockHash, Rep.Some(medianTime), Rep.Some(time))).shaped.<>({r=>import r._; _1.map(_=> BlocksRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get, _12.get, _13.get, _14, _15, _16.get, _17.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
   ...
   *  @param time Database column time SqlType(timestamp) */
  case class TransactionsRow(txid: String, blockhash: String, hash: String, hex: String, size: Int, vsize: Int, weight: Int, version: Int, lockTime: java.sql.Timestamp, blockTime: java.sql.Timestamp, time: java.sql.Timestamp)
  ...
  implicit def GetResultTransactionsRow(implicit e0: GR[String], e1: GR[Int], e2: GR[java.sql.Timestamp]): GR[TransactionsRow] = GR{
    prs => import prs._
    TransactionsRow.tupled((<<[String], <<[String], <<[String], <<[String], <<[Int], <<[Int], <<[Int], <<[Int], <<[java.sql.Timestamp], <<[java.sql.Timestamp], <<[java.sql.Timestamp]))
  }
  ...
  class Transactions(_tableTag: Tag) extends profile.api.Table[TransactionsRow](_tableTag, Some("bitcoin"), "transactions") {
    def * = (txid, blockhash, hash, hex, size, vsize, weight, version, lockTime, blockTime, time) <> (TransactionsRow.tupled, TransactionsRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(txid), Rep.Some(blockhash), Rep.Some(hash), Rep.Some(hex), Rep.Some(size), Rep.Some(vsize), Rep.Some(weight), Rep.Some(version), Rep.Some(lockTime), Rep.Some(blockTime), Rep.Some(time))).shaped.<>({r=>import r._; _1.map(_=> TransactionsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
