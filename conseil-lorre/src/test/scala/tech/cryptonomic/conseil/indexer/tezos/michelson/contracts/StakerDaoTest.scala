...
class StakerDaoTest extends ConseilSpec {
  ...
  "The Token Contracts operations for the StakerDao contract" should {
    ...
    "tzip-16" in {
      ...
      val params = """{
                     ...
                     |                        },
                     |                        {
                     |                           "string":"ipfs://QmV8LrMVaUcSViWk3rEtd578jmspzcx2uz1j7UN5ZALXT3"
                     |                        }
                     |                     ]
                     |                  }
                     |               ]
                     ...
                     |                        },
                     |                        {
                     |                           "bytes":"697066733a2f2f516d65656163446d6844585a664437344c695763317052706f6977677746515051424b3369625a63426a50354d51"
                     |                        }
                     |                     ]
                     |                  }
                     |               ]
      ...
      //register the token info
      val sut = TokenContracts.fromConfig(List(ledgerId -> "TZIP-16"))
      //set the map id for the contract
      sut.setMapId(ledgerId, mapId)
